...
class Trainer(BaseTrainer):
    def __init__(self, model, criterion, metric_ftns, optimizer, lr_scheduler, args, train_dataloader, val_dataloader,
                 test_dataloader):
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (images_id, images, reports_ids, reports_masks) in enumerate(self.train_dataloader):
            images = images.to(self.device, non_blocking=True)                  # (B, T, C, H, W)
            reports_ids = reports_ids.to(self.device, non_blocking=True)        # (B, )
            reports_masks = reports_masks.to(self.device, non_blocking=True)    # (B, )

            output = self.model(images, reports_ids)
